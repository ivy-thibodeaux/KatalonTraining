...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/p_John999139 Smith999139'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_OrangeHRM/a_Logout'), 'Logout')
